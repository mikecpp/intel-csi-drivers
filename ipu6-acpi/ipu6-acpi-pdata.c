...
void update_pdata(struct device *dev, struct ipu_isys_subdev_info *new_subdev, enum connection_type connect)
{
...
int populate_dummy(struct device *dev, char sensor_name[I2C_NAME_SIZE],	struct sensor_bios_data *cam_data,
			struct control_logic_data *ctl_data, enum connection_type connect)
{
